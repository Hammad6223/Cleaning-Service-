            ...
            <Card className="p-1 main-Content shadow border-0 "style={{width:"223px" ,height:"100px"}}>
                <Card.Body className="d-flex flex-column">
                    <div className="d-flex align-items-center gap-1">
                        ...
                        <h6 className="fw-normal mb-0" style={{color:"rgba(4, 40, 98, 1)",}}>Cleaning Time</h6>
                    </div>
                    <p className="ps-4 fs-5 fw-normal mt-1" style={{color:"rgba(59, 130, 246, 1)",
}}>1-1.5 hours</p>
                </Card.Body>
            </Card>
            ...
            <Card className="p-1 shadow border-0"style={{width:"223px" ,height:"100px"}}>
                <Card.Body className="d-flex flex-column">
                    <div className="d-flex align-items-center gap-1">
                        ...
                        <h6 className="fw-normal mb-0" style={{color:"rgba(4, 40, 98, 1)",}}>Number of People</h6>
                    </div>
